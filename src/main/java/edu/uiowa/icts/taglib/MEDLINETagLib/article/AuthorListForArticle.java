...
import edu.uiowa.icts.taglib.MEDLINETagLib.journal.Journal;
...
public class AuthorListForArticle extends MEDLINETagLibTagSupport {
    ...
    public int doStartTag() throws JspException {
        ...
        try {
            stat = getConnection().prepareStatement("select last_name, initials from medline10.author where pmid = ? order by seqnum");
            stat.setInt(1, ID);
