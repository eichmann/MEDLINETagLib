...
public class MeshQualifierIterator extends MEDLINETagLibBodyTagSupport {
	...
	public static String meshQualifierCountByMeshHeading(String pmid, String seqnum) throws JspTagException {
		...
		try {
			PreparedStatement stat = theIterator.getConnection().prepareStatement("SELECT count(*) from medline10.mesh_qualifier where 1=1"
						+ " and pmid = ?"
						+ " and seqnum = ?"
						);
    ...
    public int doStartTag() throws JspException {
      ...
      try {
            int webapp_keySeq = 1;
            stat = getConnection().prepareStatement("SELECT medline10.mesh_qualifier.pmid, medline10.mesh_qualifier.seqnum, medline10.mesh_qualifier.qnum from " + generateFromClause() + " where 1=1"
    ...
    private String generateFromClause() {
       StringBuffer theBuffer = new StringBuffer("medline10.mesh_qualifier");
