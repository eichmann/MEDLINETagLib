...
public class CassandraDao {
   ...
   * @return
   */
  public Map<String, String> getMulti( final String columnFamilyName, String columnName, String... keys) {
   ...
   */
  public void insertMulti( final String columnFamilyName,String columnName, Map<String, String> keyValues) {
   ...
   */
  public void delete( final String columnFamilyName, String columnName, String... keys) {
    Mutator<String> m = createMutator(keyspace, serializer);
    for (String key: keys) {
