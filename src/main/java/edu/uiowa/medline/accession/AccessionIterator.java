...
public class AccessionIterator extends MEDLINETagLibBodyTagSupport {
	...
	public static String accessionCountByDataBank(String pmid, String seqnum) throws JspTagException {
		...
		try {
			PreparedStatement stat = theIterator.getConnection().prepareStatement("SELECT count(*) from medline11.accession where 1=1"
						+ " and pmid = ?"
						+ " and seqnum = ?"
						);
    ...
    private String generateFromClause() {
       StringBuffer theBuffer = new StringBuffer("medline11.accession");
