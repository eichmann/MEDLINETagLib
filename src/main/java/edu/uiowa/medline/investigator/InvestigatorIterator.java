...
public class InvestigatorIterator extends MEDLINETagLibBodyTagSupport {
    int pmid = 0;
    int seqnum = 0;
	...
	public static String investigatorCountByArticle(String pmid) throws JspTagException {
		int count = 0;
		InvestigatorIterator theIterator = new InvestigatorIterator();
		try {
			PreparedStatement stat = theIterator.getConnection().prepareStatement("SELECT count(*) from medline11.investigator where 1=1"
						+ " and pmid = ?"
						);
	...
	public static Boolean articleHasInvestigator(String pmid) throws JspTagException {
		return ! investigatorCountByArticle(pmid).equals("0");
	}

	public static Boolean investigatorExists (String pmid, String seqnum) throws JspTagException {
		int count = 0;
		InvestigatorIterator theIterator = new InvestigatorIterator();
		try {
			PreparedStatement stat = theIterator.getConnection().prepareStatement("SELECT count(*) from medline11.investigator where 1=1"
    ...
    public int doStartTag() throws JspException {
      ...
      try {
            int webapp_keySeq = 1;
            stat = getConnection().prepareStatement("SELECT medline11.investigator.pmid, medline11.investigator.seqnum from " + generateFromClause() + " where 1=1"
    ...
    private String generateFromClause() {
       StringBuffer theBuffer = new StringBuffer("medline11.investigator");
