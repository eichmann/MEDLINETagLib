...
public class LanguageIterator extends MEDLINETagLibBodyTagSupport {
	...
	public static String languageCountByArticle(String pmid) throws JspTagException {
		int count = 0;
		LanguageIterator theIterator = new LanguageIterator();
		try {
			PreparedStatement stat = theIterator.getConnection().prepareStatement("SELECT count(*) from medline10.language where 1=1"
						+ " and pmid = ?"
						);
	...
	public static Boolean articleHasLanguage(String pmid) throws JspTagException {
		return ! languageCountByArticle(pmid).equals("0");
	}

	public static Boolean languageExists (String pmid, String seqnum) throws JspTagException {
		int count = 0;
		LanguageIterator theIterator = new LanguageIterator();
		try {
			PreparedStatement stat = theIterator.getConnection().prepareStatement("SELECT count(*) from medline10.language where 1=1"
    ...
    public int doStartTag() throws JspException {
      ...
      try {
            int webapp_keySeq = 1;
            stat = getConnection().prepareStatement("SELECT medline10.language.pmid, medline10.language.seqnum from " + generateFromClause() + " where 1=1"
    ...
    private String generateFromClause() {
       StringBuffer theBuffer = new StringBuffer("medline10.language");
