...
public class MeshHeadingIterator extends MEDLINETagLibBodyTagSupport {
	...
	public static String meshHeadingCountByArticle(String pmid) throws JspTagException {
		int count = 0;
		MeshHeadingIterator theIterator = new MeshHeadingIterator();
		try {
			PreparedStatement stat = theIterator.getConnection().prepareStatement("SELECT count(*) from medline10.mesh_heading where 1=1"
						+ " and pmid = ?"
						);
	...
	public static Boolean articleHasMeshHeading(String pmid) throws JspTagException {
		return ! meshHeadingCountByArticle(pmid).equals("0");
	}

	public static Boolean meshHeadingExists (String pmid, String seqnum) throws JspTagException {
		int count = 0;
		MeshHeadingIterator theIterator = new MeshHeadingIterator();
		try {
			PreparedStatement stat = theIterator.getConnection().prepareStatement("SELECT count(*) from medline10.mesh_heading where 1=1"
    ...
    public int doStartTag() throws JspException {
      ...
      try {
            int webapp_keySeq = 1;
            stat = getConnection().prepareStatement("SELECT medline10.mesh_heading.pmid, medline10.mesh_heading.seqnum from " + generateFromClause() + " where 1=1"
    ...
    private String generateFromClause() {
       StringBuffer theBuffer = new StringBuffer("medline10.mesh_heading");
